...
function printUsage(): void {
  console.log(
    [
      ...
      "  pnpm -C apps/web ai:provider-smoke --provider=gemini --mode=probe",
      ...
      "",
      "Flags:",
      "  --provider <name>          One provider: openai|anthropic|mistral|gemini",
      "  --providers <csv|alias>    CSV list or all-primary|all-optional",
