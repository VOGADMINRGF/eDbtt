...
describe("/admin/review page", () => {
  it("renders the central review queue with clear guardrails", async () => {
    ...
    expect((html.match(/data-testid=\"admin-review-voxy-/g) ?? []).length).toBe(27);
    ...
    expect((html.match(/data-testid=\"admin-review-voxy-hybrid-runtime-foundation-/g) ?? []).length).toBe(1);
