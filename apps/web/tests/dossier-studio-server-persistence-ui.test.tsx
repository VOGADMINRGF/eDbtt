...
describe("dossier studio server persistence UI", () => {
  ...
  it("shows persisted server workspace status without claiming publication", async () => {
    ...
    expect(html).toContain("Voxy-Provider-Selection-Draft-Store");
    ...
    expect(html).toContain("Preview-Outcome-Handoff-Store");
    ...
    expect(html).toContain('data-testid="dossier-studio-editorial-series"');
    ...
    expect(html).toContain('data-testid="dossier-studio-voxy-render-provider-selection-draft"');
    expect(html).toContain('data-testid="dossier-studio-voxy-hybrid-runtime-foundation"');
