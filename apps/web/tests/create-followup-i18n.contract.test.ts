...
describe("create follow-up i18n contract", () => {
  ...
  it("uses understandable contribute follow-up wording without classification-flow phrasing", () => {
    ...
    expect(de.followupContributeTitle).toBe("Ich sehe einen gemeinsamen Kern.");
    expect(de.followupContributeLead).toBe("Ich sortiere Thema, Kontext und nächste Schritte kompakt vor. Alles bleibt review-first.");
    ...
    expect(en.followupContributeTitle).toBe("I see a shared core.");
