...
describe("stream dossier recap handoff", () => {
  beforeEach(() => {
    vi.clearAllMocks();
  ...
  it("prepares dossier, Anlassraum and social follow-up hints without auto-publishing", async () => {
    ...
    expect(runtime?.recap.anlassraumUpdateHint).toContain("Anlassraum");
