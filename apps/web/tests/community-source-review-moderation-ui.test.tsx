...
describe("community source review moderation ui", () => {
  it("renders community hints with moderation, risk, abuse, trust and guardrails in admin review", async () => {
    ...
    expect(html).toContain("Community-Hinweise sind Review-Signale, keine bestätigten Fakten.");
    expect(html).toContain("Viele Hinweise bedeuten keine Wahrheit.");
    expect(html).toContain("Trust priorisiert Prüfung, ersetzt sie aber nicht.");
