  ...
  return {
    ...
    meta: {
      ...
      analysis: {
        ...
        analysisId: "analysis-candidate-preview",
        sourceType: "text" as const,
        sourceUrl: null,
        sourceContentHash: "hash-candidate-preview",
        analyzedAt: "2026-07-03T14:00:00.000Z",
...
describe("create candidate preview contract", () => {
  ...
  it("renders the preview panel as a review-first, preview-only surface", () => {
    ...
    expect(html).toContain('data-testid="create-candidate-voxy-render-request-draft"');
    ...
    expect(html).toContain('data-testid="create-candidate-voxy-render-runtime-observability"');
    expect(html).toContain('data-testid="create-candidate-voxy-render-runtime-cutover-gate"');
    ...
    expect(html).toContain("Noch nicht serverseitig gesichert");
    ...
    expect(html).toContain("Dossier-Handoff vorbereitet");
    expect(html).toContain("Für den nächsten Arbeitsstand vorgemerkt");
    expect(html).toContain("Graph-Verknüpfung");
    expect(html).toContain("Thema:");
    expect(html).toContain("Offene Anschlussdaten");
    ...
    expect(html).not.toContain("create_handoff_review_queue");
