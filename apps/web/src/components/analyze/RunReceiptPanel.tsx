  ...
  return (
    <div className="rounded-xl border border-[rgb(var(--border))] bg-[rgb(var(--card))] p-3 shadow-sm">
      <div className="flex items-start justify-between gap-2">
        <div>
          <div className="text-[11px] font-semibold uppercase tracking-wide text-[rgb(var(--muted))]">RunReceipt</div>
          <div className="text-sm font-medium text-[rgb(var(--fg))]">{receipt.id}</div>
      ...
      <div className="mt-3 grid gap-2 text-[11px] text-[rgb(var(--muted))] sm:grid-cols-2">
        <div className="rounded-lg border border-[rgb(var(--border))] bg-[rgb(var(--card))] p-2">
          <div className="text-[rgb(var(--muted))]">receiptHash</div>
          <div className="font-mono">{short(receipt.receiptHash, 22)}</div>
        </div>
        <div className="rounded-lg border border-[rgb(var(--border))] bg-[rgb(var(--card))] p-2">
          <div className="text-[rgb(var(--muted))]">snapshotId</div>
          <div className="font-mono">{short(receipt.snapshotId, 22)}</div>
        </div>
        <div className="rounded-lg border border-[rgb(var(--border))] bg-[rgb(var(--card))] p-2">
          <div className="text-[rgb(var(--muted))]">inputHash</div>
          <div className="font-mono">{short(receipt.inputHash, 22)}</div>
        </div>
        <div className="rounded-lg border border-[rgb(var(--border))] bg-[rgb(var(--card))] p-2">
          <div className="text-[rgb(var(--muted))]">sourcesHash</div>
