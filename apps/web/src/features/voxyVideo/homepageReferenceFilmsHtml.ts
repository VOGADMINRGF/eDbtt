...
export function renderVoxyHomepageReferenceFilmFrameHtml(input: {
  ...
  const css = `<style>
    ...
    [data-homepage-visual-state="FOCUS"] .broadcast-lower-third,[data-homepage-visual-state="EXPLAIN"] .broadcast-lower-third{min-height:102px!important;background:linear-gradient(135deg,rgba(3,16,38,.78),rgba(1,8,23,.86))!important;box-shadow:0 16px 38px rgba(0,0,0,.28)!important}.homepage-reference-v3[data-homepage-visual-state="FOCUS"] .lower-copy p,.homepage-reference-v3[data-homepage-visual-state="EXPLAIN"] .lower-copy p{display:none!important}
    .information-stage{left:970px!important;top:220px!important;width:350px!important;height:255px!important;padding:21px 23px!important;border-radius:18px!important;background:linear-gradient(145deg,rgba(5,18,45,.9),rgba(2,9,25,.93))!important;box-shadow:0 22px 60px rgba(0,0,0,.35),0 0 36px rgba(21,112,255,.08)!important;--dock-x:500px!important;--dock-y:-105px!important;--dock-scale:.42!important}.information-stage .fixture-label{font-size:7px!important;padding:3px 6px!important}.information-stage .evidence-kind{margin-top:9px!important;font-size:8px!important}.information-stage .evidence-core h1{font-size:23px!important}.information-stage .trend-chart,.information-stage .participation-chart{height:100px!important;margin-top:12px!important}.information-stage .trend-chart svg{height:78px!important}.information-stage .participation-chart i{height:calc(var(--bar)*75px)!important}.synthesis-stage{opacity:0!important;pointer-events:none!important}
    ...
    .source-pull-scene{position:absolute;inset:55px 35px 25px 20px}.source-pull-scene .case-headline-object{left:-18px;top:130px;transform:translateX(calc((1 - var(--segment-progress))*-18px))}.case-source-object{position:absolute;width:430px;height:250px;padding:18px 20px;border-radius:12px;background:linear-gradient(145deg,#eaf3f7,#d3e2e9);color:#102033;box-shadow:0 24px 60px rgba(0,0,0,.28)}.source-pull-scene .case-source-object{right:15px;top:76px;transform:translateX(calc((1 - var(--segment-progress))*25px))}.case-source-object header,.case-source-object footer{display:flex;justify-content:space-between;align-items:center;font-size:8px;letter-spacing:.1em}.case-source-object header b{color:#006e76}.case-source-object footer{position:absolute;left:20px;right:20px;bottom:14px;color:#627d90;border-top:1px solid rgba(31,71,94,.15);padding-top:8px}.source-line{display:block;width:86%;height:6px;margin-top:11px;border-radius:5px;background:rgba(38,66,82,.14)}.source-line.wide{width:100%;margin-top:20px}.source-line.medium{width:70%}.source-line.short{width:48%}.source-passage{height:34px;margin:13px -3px 0;padding-left:12px;display:flex;align-items:center;border-left:4px solid #00a9a0;background:linear-gradient(90deg,rgba(0,169,160,.2) calc(var(--passage)*100%),rgba(40,72,91,.06) calc(var(--passage)*100%))}.source-passage span{font-size:8px;font-weight:900;letter-spacing:.12em;color:#006c70}.evidence-beam{position:absolute;left:320px;top:195px;width:240px;display:flex;align-items:center;gap:8px;color:#5be0d6;font-size:8px;font-weight:900;letter-spacing:.12em}.evidence-beam i{height:2px;flex:1;background:linear-gradient(90deg,#38d6cc,#3788e3);transform-origin:left;transform:scaleX(var(--segment-progress))}
    .forensic-split-scene{position:absolute;inset:48px 28px 30px 10px}.forensic-split-scene .case-source-object{left:555px;top:78px}.claim-token{position:absolute;width:145px;height:88px;padding:12px 14px;border:1px solid rgba(76,156,209,.42);border-radius:12px;background:rgba(5,27,51,.92);box-shadow:0 18px 40px rgba(0,0,0,.22);transform:scale(calc(.88 + var(--segment-progress)*.12))}.claim-token b{display:block;margin-top:6px;font-size:21px}.claim-token span{display:block;margin-top:5px;color:#8eabc0;font-size:9px}.claim-token.number{left:10px;top:55px}.claim-token.quote{right:28px;top:360px}.claim-token.study{left:38px;bottom:80px}.split-rule{position:absolute;left:15px;bottom:42px;width:900px;display:grid;grid-template-columns:auto 1fr auto;gap:13px;align-items:center;color:#a9c4d7;font-size:9px;font-weight:900;letter-spacing:.1em}.split-rule i{height:2px;background:linear-gradient(90deg,#45d9d0,#ffb45e)}
    ...
    .programme-gap-scene{position:absolute;inset:80px 55px 45px 55px}.promise-object,.decision-object{position:absolute;top:85px;height:168px;padding:22px;border-radius:18px;background:linear-gradient(145deg,rgba(10,41,79,.92),rgba(4,19,42,.94));border:1px solid rgba(91,157,224,.42)}.promise-object{left:0;width:250px}.decision-object{right:5px;width:300px}.promise-object small,.decision-object small,.demophobie-source small,.design-question small,.current-layer small,.future-layer small,.closing-copy small{color:#76b7ff;font-size:8px;font-weight:900;letter-spacing:.13em}.promise-object strong,.decision-object strong{display:block;margin-top:10px;font-size:27px}.promise-object span,.decision-object span{display:block;margin-top:9px;color:#97b0c5;font-size:10px}.gap-field{position:absolute;left:335px;top:260px;width:210px;text-align:center}.gap-field b{font-size:42px;color:#ffbc70}.gap-field span{display:inline-block;margin-left:10px;color:#b4c6d6;font-size:8px;font-weight:900;letter-spacing:.1em}.status-ruler{position:absolute;left:15px;right:15px;bottom:20px;display:grid;grid-template-columns:repeat(6,1fr);gap:6px;color:#6887a2;font-size:7px;font-weight:900;letter-spacing:.05em;text-align:center}.status-ruler i{position:absolute;left:0;right:0;top:-10px;height:2px;background:linear-gradient(90deg,#3e88cf,#55d1c8)}
    .demophobie-space{position:absolute;inset:70px 55px 40px 45px}.demophobie-source{position:absolute;left:-15px;top:75px;width:280px;padding:20px;border-left:3px solid #73b7ff;background:linear-gradient(90deg,rgba(10,40,78,.88),rgba(5,19,43,.55))}.demophobie-source strong{display:block;margin-top:10px;font-size:31px}.demophobie-source span{display:block;margin-top:8px;color:#9db5ca;font-size:9px}.design-question{position:absolute;right:10px;top:70px;width:390px;padding:23px;border:1px solid rgba(94,158,221,.44);border-radius:20px;background:rgba(4,19,43,.8)}.design-question b{display:block;margin-top:12px;font-size:23px;line-height:1.08}.guardrail{position:absolute;padding:9px 12px;border:1px solid rgba(86,148,204,.35);border-radius:999px;background:rgba(5,24,48,.8);color:#92acc2;font-size:8px;font-weight:900;letter-spacing:.08em}.g1{left:5px;bottom:66px}.g2{left:185px;bottom:22px}.g3{right:215px;bottom:28px}.g4{right:30px;bottom:72px}
    .participation-balance-scene{position:absolute;inset:95px 35px 45px 35px}.extreme{position:absolute;width:210px;padding:17px;border:1px solid rgba(91,145,197,.34);border-radius:16px;background:rgba(5,22,45,.72);text-align:center}.extreme.left{left:0;top:95px}.extreme.right{left:0;top:225px;right:auto}.extreme small{color:#718fa9;font-size:8px;font-weight:900}.extreme strong{display:block;margin-top:8px;font-size:17px}.balance-core{position:absolute;left:auto;right:35px;top:65px;width:350px;height:275px;display:grid;place-content:center;text-align:center;border:1px solid rgba(73,213,203,.5);border-radius:50%;background:radial-gradient(circle,rgba(24,111,146,.19),rgba(4,20,44,.68))}.balance-core i{position:absolute;inset:28px;border:1px solid rgba(90,177,230,.28);border-radius:50%;transform:scale(calc(.84 + var(--segment-progress)*.18))}.balance-core strong{font-size:20px}.balance-core span{max-width:230px;margin:10px auto 0;color:#9ab6ca;font-size:10px}.balance-axis{position:absolute;left:210px;right:385px;top:200px;z-index:-1}.balance-axis i{display:block;height:3px;background:linear-gradient(90deg,#54708a,#2fcfc4)}
    .vog-offer-scene{position:absolute;inset:75px 55px 45px 55px}.current-layer,.future-layer{position:absolute;left:505px;right:5px;height:132px;padding:20px 22px;border-radius:17px}.current-layer{top:45px;border:1px solid rgba(77,162,225,.46);background:linear-gradient(135deg,rgba(9,41,78,.88),rgba(5,20,45,.84))}.future-layer{bottom:25px;border:1px dashed rgba(66,211,201,.5);background:rgba(4,26,44,.5)}.current-layer strong,.future-layer strong{display:block;margin-top:8px;font-size:18px}.current-layer span,.future-layer span{display:block;margin-top:7px;color:#9bb4c8;font-size:9px}.bridge{position:absolute;left:535px;top:180px;width:250px;display:flex;align-items:center;gap:10px;color:#62d8d0;font-size:8px;font-weight:900;letter-spacing:.08em}.bridge i{height:2px;flex:1;background:linear-gradient(90deg,#478fe0,#37d5cb)}
  ...
  let html = replaceHomepageLapelPin(base)
    ...
    .replace(
      ...
      `data-pilot-version="homepage-reference-v3-face-safe" class="homepage-reference-v3" data-homepage-film="${plan.filmId}" data-context-mode="${plan.contextMode}" data-visual-language="${plan.visualLanguage}" data-homepage-visual-state="${visualState.state}" data-motion-event-index="${eventIndex}" data-host-face-safe-zone="x610-900:y150-520"`,
    );
