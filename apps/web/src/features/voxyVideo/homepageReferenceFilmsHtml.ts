...
function renderEdebateForensics(
  ...
  const synthesisScene = `<div class="case-synthesis-scene" data-face-safe-route="outside-host-corridor">
...
export function renderVoxyHomepageReferenceFilmFrameHtml(input: {
  ...
  const css = `<style>
    ...
    [data-pilot-version="homepage-reference-v3-1-surgical"][data-homepage-visual-state="FOCUS"] .broadcast-lower-third,[data-pilot-version="homepage-reference-v3-1-surgical"][data-homepage-visual-state="EXPLAIN"] .broadcast-lower-third{min-height:86px!important;padding:10px 16px!important;grid-template-columns:4px 1fr 0!important;background:linear-gradient(135deg,rgba(3,16,38,.7),rgba(1,8,23,.78))!important;box-shadow:0 12px 28px rgba(0,0,0,.22)!important}[data-pilot-version="homepage-reference-v3-1-surgical"][data-homepage-visual-state="FOCUS"] .lower-copy p,[data-pilot-version="homepage-reference-v3-1-surgical"][data-homepage-visual-state="EXPLAIN"] .lower-copy p,[data-pilot-version="homepage-reference-v3-1-surgical"][data-homepage-visual-state="FOCUS"] .lower-meta,[data-pilot-version="homepage-reference-v3-1-surgical"][data-homepage-visual-state="EXPLAIN"] .lower-meta{display:none!important}[data-pilot-version="homepage-reference-v3-1-surgical"][data-homepage-visual-state="FOCUS"] .lower-copy strong,[data-pilot-version="homepage-reference-v3-1-surgical"][data-homepage-visual-state="EXPLAIN"] .lower-copy strong{font-size:20px!important}
    .information-stage{left:1030px!important;top:165px!important;width:340px!important;height:92px!important;padding:10px 14px!important;border-radius:14px!important;background:linear-gradient(145deg,rgba(5,18,45,.88),rgba(2,9,25,.92))!important;box-shadow:0 16px 38px rgba(0,0,0,.3),0 0 24px rgba(21,112,255,.06)!important;--dock-scale:.55!important}.information-stage[data-evidence-id="edebatte-source-chain"],.information-stage[data-evidence-id="vog-evergreen-impact-loop"]{--dock-x:450px!important;--dock-y:105px!important}.information-stage[data-evidence-id="edebatte-status-ladder"],.information-stage[data-evidence-id="vog-accountability-chain"]{--dock-x:450px!important;--dock-y:245px!important}.information-stage .fixture-label{display:none!important}.information-stage .evidence-kind{margin-top:0!important;font-size:7px!important}.information-stage .evidence-core h1{max-width:310px!important;margin-top:5px!important;font-size:17px!important;line-height:1.02!important}.information-stage .trend-chart,.information-stage .participation-chart,.information-stage .question-ring,.information-stage .trend-note{display:none!important}.information-stage .evidence-question{display:block!important}.synthesis-stage{opacity:0!important;pointer-events:none!important}
    ...
    .programme-gap-scene{position:absolute;inset:80px 55px 45px 55px}.promise-object,.decision-object{position:absolute;top:85px;height:168px;padding:22px;border-radius:18px;background:linear-gradient(145deg,rgba(10,41,79,.92),rgba(4,19,42,.94));border:1px solid rgba(91,157,224,.42)}.promise-object{left:0;width:190px}.decision-object{right:5px;width:300px}.promise-object small,.decision-object small,.demophobie-source small,.design-question small,.current-layer small,.future-layer small,.closing-copy small{color:#76b7ff;font-size:8px;font-weight:900;letter-spacing:.13em}.promise-object strong,.decision-object strong{display:block;margin-top:10px;font-size:27px}.promise-object span,.decision-object span{display:block;margin-top:9px;color:#97b0c5;font-size:10px}.gap-field{position:absolute;right:20px;top:115px;width:360px;text-align:center}.gap-field b{display:block;font-size:48px;color:#ffbc70}.gap-field span{display:block;margin-top:7px;color:#dbe8f4;font-size:14px;font-weight:900;letter-spacing:.06em}.gap-field em{display:block;margin-top:9px;color:#8eaac1;font-size:9px;font-style:normal;font-weight:900;letter-spacing:.1em}.status-ruler{position:absolute;left:500px;right:15px;bottom:20px;display:grid;grid-template-columns:repeat(6,1fr);gap:6px;color:#6887a2;font-size:7px;font-weight:900;letter-spacing:.05em;text-align:center}.status-ruler i{position:absolute;left:0;right:0;top:-10px;height:2px;background:linear-gradient(90deg,#3e88cf,#55d1c8)}
    .demophobie-space{position:absolute;inset:70px 55px 40px 45px}.demophobie-source{position:absolute;left:-15px;top:75px;width:210px;padding:20px;border-left:3px solid #73b7ff;background:linear-gradient(90deg,rgba(10,40,78,.88),rgba(5,19,43,.55))}.demophobie-source strong{display:block;margin-top:10px;font-size:29px}.demophobie-source span{display:block;margin-top:8px;color:#9db5ca;font-size:9px}.design-question{position:absolute;right:10px;top:70px;width:390px;padding:23px;border:1px solid rgba(94,158,221,.44);border-radius:20px;background:rgba(4,19,43,.8)}.design-question b{display:block;margin-top:12px;font-size:23px;line-height:1.08}.guardrail-row{position:absolute;left:500px;right:0;bottom:22px;display:flex;flex-wrap:wrap;justify-content:flex-end;gap:9px}.guardrail{padding:9px 12px;border:1px solid rgba(86,148,204,.35);border-radius:999px;background:rgba(5,24,48,.8);color:#92acc2;font-size:8px;font-weight:900;letter-spacing:.08em}
    .participation-balance-scene{position:absolute;inset:95px 35px 45px 35px}.extreme{position:absolute;width:210px;padding:17px;border:1px solid rgba(91,145,197,.34);border-radius:16px;background:rgba(5,22,45,.72);text-align:center}.extreme.left{left:0;top:95px}.extreme.right{left:0;top:225px;right:auto}.extreme small{color:#718fa9;font-size:8px;font-weight:900}.extreme strong{display:block;margin-top:8px;font-size:17px}.balance-core{position:absolute;left:auto;right:35px;top:65px;width:350px;height:275px;display:grid;place-content:center;text-align:center;border:1px solid rgba(73,213,203,.5);border-radius:50%;background:radial-gradient(circle,rgba(24,111,146,.19),rgba(4,20,44,.68))}.balance-core i{position:absolute;inset:28px;border:1px solid rgba(90,177,230,.28);border-radius:50%;transform:scale(calc(.84 + var(--segment-progress)*.18))}.balance-core strong{font-size:20px}.balance-core span{max-width:230px;margin:10px auto 0;color:#9ab6ca;font-size:10px}.balance-axis{position:absolute;left:210px;right:385px;top:390px;z-index:-1}.balance-axis i{display:block;height:3px;background:linear-gradient(90deg,#54708a,#2fcfc4)}
    .vog-offer-scene{position:absolute;inset:75px 55px 45px 55px}.current-layer,.future-layer{position:absolute;left:505px;right:5px;height:132px;padding:20px 22px;border-radius:17px}.current-layer{top:105px;border:1px solid rgba(77,162,225,.46);background:linear-gradient(135deg,rgba(9,41,78,.88),rgba(5,20,45,.84))}.future-layer{top:105px;border:1px dashed rgba(66,211,201,.5);background:rgba(4,26,44,.5)}.current-layer strong,.future-layer strong{display:block;margin-top:8px;font-size:18px}.current-layer span,.future-layer span{display:block;margin-top:7px;color:#9bb4c8;font-size:9px}.bridge{position:absolute;left:535px;top:175px;width:300px;display:flex;align-items:center;gap:10px;color:#62d8d0;font-size:9px;font-weight:900;letter-spacing:.08em}.bridge i{height:2px;flex:1;background:linear-gradient(90deg,#478fe0,#37d5cb)}
  ...
  let html = replaceHomepageLapelPin(base)
    ...
    .replace(
      ...
      `data-pilot-version="homepage-reference-v3-1-surgical" data-homepage-film="${plan.filmId}" data-context-mode="${plan.contextMode}" data-visual-language="${plan.visualLanguage}" data-homepage-visual-state="${visualState.state}" data-motion-event-index="${eventIndex}" data-host-face-safe-zone="x610-900:y150-520" data-host-face-safe-policy="hard-no-lines-or-large-objects"`,
    );
