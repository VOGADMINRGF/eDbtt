...
const ES: OperatorTexts = {
  ...
  anlassraumDetail: {
    ...
    loadingOutputSeeds: "Cargando output seeds ...",
    emptyOutputSeeds: "No hay output seeds.",
...
const FR: OperatorTexts = {
  ...
  anlassraumDetail: {
    ...
    loadingOutputSeeds: "Chargement des output seeds ...",
    emptyOutputSeeds: "Aucun output seed trouvé.",
...
const ZH: OperatorTexts = {
  ...
  anlassraumDetail: {
    ...
    colLastAction: "最后操作",
    colNextAction: "下一步操作",
    loadingOutputSeeds: "正在加载 output seeds...",
    emptyOutputSeeds: "暂无 output seeds。",
