    ...
    <div className="flex flex-col gap-10">
      ...
      {preorderNotice && (
        <div className="mb-4 rounded-2xl border border-emerald-200 bg-emerald-50 px-4 py-3 text-sm text-emerald-900 dark:border-emerald-500/35 dark:bg-emerald-500/12 dark:text-emerald-100">
          Paketstart gespeichert. Wenn du eine E-Mail angegeben hast, senden wir dir eine Bestätigung. Die Freischaltung
          erfolgt anschließend passend zum Paket und Nutzungskontext.
        </div>
      )}
