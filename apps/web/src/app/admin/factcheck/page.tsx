    ...
    <div className="space-y-6">
      ...
      <section className="rounded-3xl border border-[rgb(var(--border))] bg-[rgb(var(--card))] p-5 shadow-sm space-y-4">
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            onClick={loadItems}
            className="rounded-full border border-[rgb(var(--border))] bg-[rgb(var(--card))] px-4 py-1.5 text-xs font-semibold text-[rgb(var(--muted))]"
          >
            Neu laden
          </button>
        </div>
        <div className="space-y-2">
          <label className="text-xs font-semibold uppercase text-[rgb(var(--muted))]">Review-Notiz (optional)</label>
          <input
            value={reviewNote}
      ...
      {loading ? (
        ...
        <div className="grid gap-4 lg:grid-cols-2">
          {items.map((item) => (
            <article key={item.id} className="rounded-3xl border border-[rgb(var(--border))] bg-[rgb(var(--card))] p-5 shadow-sm space-y-3">
              ...
              <div>
                <p className="text-sm font-semibold text-[rgb(var(--fg))]">{item.action.claim}</p>
              ...
              {item.action.note && (
                <p className="text-xs text-[rgb(var(--muted))]">Notiz: {item.action.note}</p>
              )}
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                <button
                  ...
                  className="rounded-full border border-[rgb(var(--border))] bg-[rgb(var(--card))] px-3 py-1.5 text-xs font-semibold text-[rgb(var(--muted))]"
                >
                  Offen setzen
                </button>
              </div>
