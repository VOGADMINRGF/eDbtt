    ...
    <main className="min-h-screen bg-[rgb(var(--bg))] pb-16">
      <section className="mx-auto max-w-5xl px-4 pt-14">
        <div className="rounded-3xl bg-[rgb(var(--card))] p-6 shadow-[0_24px_70px_rgba(15,23,42,0.08)] ring-1 ring-[rgb(var(--border))] md:p-10">
          ...
          {/* Meta-Block */}
          <section className="mt-8 grid gap-4 rounded-2xl bg-[rgb(var(--bg))] p-4 text-sm text-[rgb(var(--muted))] md:grid-cols-2 md:p-6">
            ...
            <div className="space-y-2 md:border-l md:border-[rgb(var(--border))] md:pl-6">
          ...
          {/* Intro Note */}
          <section className="mt-8 rounded-2xl bg-sky-50/80 p-4 text-sm text-[rgb(var(--fg))] md:p-5">
          ...
          <div className="mt-10 space-y-10">
            {strings.sections.map((section) => (
              <section key={section.id} id={section.id} className="space-y-4">
                <h2 className="text-xl font-semibold text-[rgb(var(--fg))] md:text-2xl">
                  {section.title}
                </h2>

                <div className="space-y-3 text-sm leading-relaxed text-[rgb(var(--fg))] md:text-base">
                ...
                {section.bullets &&
                  section.bullets.map((group, idx) => (
                    <div
                      key={idx}
                      className="mt-2 space-y-1 rounded-xl bg-[rgb(var(--bg))] p-3 text-sm text-[rgb(var(--fg))] md:p-4"
                    >
