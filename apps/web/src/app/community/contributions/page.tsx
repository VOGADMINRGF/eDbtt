  ...
  return (
    <main className="mx-auto flex max-w-5xl flex-col gap-8 px-4 py-10">
      <header className="space-y-2">
        <p className="text-xs font-semibold uppercase tracking-wide text-slate-500">Community · Beiträge</p>
        <h1 className="text-3xl font-bold text-slate-900">Strukturierte Beiträge einreichen</h1>
      ...
      <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
        <div className="flex items-center justify-between gap-3">
          <h2 className="text-sm font-semibold text-slate-900">Freigegebene Beiträge</h2>
          <button
        ...
        {loading && <p className="mt-3 text-sm text-slate-500">Lädt …</p>}
        {error && (
        ...
        {!loading && !error && items.length === 0 && (
          <p className="mt-3 text-sm text-slate-500">Noch keine freigegebenen Beiträge.</p>
        )}
