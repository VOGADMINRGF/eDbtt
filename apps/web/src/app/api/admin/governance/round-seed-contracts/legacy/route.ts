...
import { listLegacyRoundSeedContractsAuthorized } from "@features/topicRound/seedContract";
...
export async function GET(req: NextRequest) {
  ...
  try {
    const items = await listLegacyRoundSeedContractsAuthorized(gate.actor, { limit });
