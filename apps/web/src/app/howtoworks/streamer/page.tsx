      ...
      <section className="mx-auto max-w-5xl px-4 py-16 space-y-8">
        ...
        <section className="grid gap-4 md:grid-cols-2">
          <article className="rounded-2xl border border-slate-200 bg-white/90 p-4 shadow-sm">
            <h2 className="text-base font-semibold text-slate-900">1. Zugang & Gating</h2>
          ...
          <article className="rounded-2xl border border-slate-200 bg-white/90 p-4 shadow-sm">
            <h2 className="text-base font-semibold text-slate-900">2. Setup in 5 Minuten</h2>
            <ul className="mt-3 list-disc space-y-1 pl-5 text-sm text-slate-700">
        ...
        <section className="grid gap-4 md:grid-cols-2">
          <article className="rounded-2xl border border-slate-200 bg-white/90 p-4 shadow-sm">
            <h2 className="text-base font-semibold text-slate-900">3. Moderationsmodus</h2>
            <ul className="mt-3 list-disc space-y-1 pl-5 text-sm text-slate-700">
          ...
          <article className="rounded-2xl border border-slate-200 bg-white/90 p-4 shadow-sm">
            <h2 className="text-base font-semibold text-slate-900">4. Nützliche Links</h2>
            <div className="mt-3 flex flex-wrap gap-2 text-sm">
              <Link className="rounded-full border border-slate-300 px-4 py-2" href="/dashboard/streams">
                Stream Dashboard
              </Link>
              <Link className="rounded-full border border-slate-300 px-4 py-2" href="/stream">
                Öffentliche Streams
              </Link>
              <Link className="rounded-full border border-slate-300 px-4 py-2" href="/howtoworks/edebatte">
                eDebatte erklärt
              </Link>
            </div>
          </article>
