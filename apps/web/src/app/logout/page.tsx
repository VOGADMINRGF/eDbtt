  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-sky-50 via-white to-white">
      <div className="mx-auto flex max-w-3xl flex-col items-center gap-4 px-4 py-16 text-center">
        <div className="rounded-3xl bg-[rgb(var(--card))] px-6 py-8 shadow-[0_18px_45px_rgba(15,23,42,0.06)] ring-1 ring-[rgb(var(--border))] space-y-3">
          ...
          <div className="flex flex-wrap items-center justify-center gap-2 pt-2">
            ...
            <a
              href="/"
              className="inline-flex items-center justify-center rounded-full border border-[rgb(var(--border))] bg-[rgb(var(--card))] px-4 py-2 text-sm font-semibold text-[rgb(var(--muted))] shadow-sm transition hover:border-sky-300 hover:text-sky-700 focus:outline-none focus:ring-2 focus:ring-sky-200"
            >
              Zur Startseite
            </a>
          </div>
