...
| Auth / Membership / Directory | `pilot_ready` | Externe Membership-/Directory-/Register-Wahrheit mit sauberem Scope-, Rollen- und Freischaltungsmodell | Externe Provider-/Directory-Anbindung; Konflikt-/Sync-Modell; Register-/Membership-Handoff; org-/region-sichere Self-Service-Aufloesung | Aktuell lokaler Runtime-Store; keine breite externe Aufloesung, kein finaler Sync-/Conflict-Layer | Verification-Reviews, Ausnahmebehandlung und Directory-Betrieb fehlen als Vollprozess | Kein stiller Admin-Fallback, Source-of-Truth-/Confidence-Marker, vollstaendiger Auth-/Scope-Audittrail | RequestScope-/RuntimeAdapter-/Org-/Admin-/Studio-Regressionssuiten, Build, manuelle Account-/Role-Journeys | sehr hoch |
