...
import type {
  PublicAnlassraumInputKind,
  PublicAnlassraumInputPayload,
  PublicAnlassraumInputRoomContext,
} from "../publicInput";
import { publicAnlassraumInputKindLabel } from "../publicInput";
...
function deriveTopics(params: {
  ...
  return uniqueNonEmpty([
    publicAnlassraumInputKindLabel(params.kind),
    params.room.title,
