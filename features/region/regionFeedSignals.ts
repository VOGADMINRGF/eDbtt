...
export const REGION_FEED_SOURCE_FIXTURES: readonly RegionFeedSource[] = [
  parseRegionFeedSource({
    ...
    label: "Pilotvorschau Reinickendorf",
    description:
      "Kuratierte Startlage als Pilotvorschau fuer den regionalen Review-Pfad. Keine echten Nachrichten, keine Live-Quelle.",
    url: null,
  ...
  parseRegionFeedSource({
    ...
    label: "Pilotvorschau Verwaltungshinweis Reinickendorf",
    description:
      "Kuratierte Verwaltungsvorschau fuer Review- und Dossiervorschlaege. Nicht als Live-Verwaltungsmitteilung bewerben.",
    url: null,
    provenance: PILOT_PROVENANCE,
    noScrapingByDefault: true,
    noTenderMonitoring: true,
  ...
  parseRegionFeedSource({
    ...
    sourceType: "manual_note",
    label: "Pilotvorschau Magdeburg",
    description:
      "Kommunale Pilotvorschau fuer getrennte Region-Tests. Keine Live-Quelle und kein Produktionsfeed.",
    url: null,
    provenance: PILOT_PROVENANCE,
    noScrapingByDefault: true,
    noTenderMonitoring: true,
...
export const REGION_FEED_SIGNAL_FIXTURES: readonly RegionFeedSignal[] = [
  parseRegionFeedSignal({
    ...
    sourceType: "official_update",
    title: "Pilotvorschau: Review-bestätigter Hinweis zu Schulsanierung und Bauzustand",
    summary:
      "Akzeptierte kuratierte Startlage für den kontrollierten Draft-Pfad. Keine echte Nachricht, keine produktive Verwaltungsmitteilung.",
    url: null,
    publishedAt: "2026-05-14T00:00:00.000Z",
    detectedTopics: ["Schulsanierung", "Schulgebäude", "Bauzustand"],
    ...
    openQuestions: [
      "Welche Schulen sollen zuerst in einen Draft überführt werden?",
      "Welche Zuständigkeiten müssen im Draft getrennt markiert werden?",
    ],
    reviewHint: "Akzeptierte Pilotvorschau für review-gated Draft-Erstellung. Keine Produktivnachricht.",
  ...
  parseRegionFeedSignal({
    ...
    summary:
      "Kuratierte Startlage zu wiederkehrenden Hinweisen auf Schulgebaeude, Sanierungsbedarf und offene Zustandsfragen im Bezirk.",
    url: null,
    publishedAt: "2026-05-14T00:00:00.000Z",
  ...
  parseRegionFeedSignal({
    id: "region-feed-signal-reinickendorf-archived-001",
    kind: "region_feed_signal",
    regionId: "bezirk-berlin-reinickendorf",
    sourceId: "feed-source-reinickendorf-pilot-briefing",
    sourceType: "manual_note",
    title: "Pilotvorschau: Archivierter Hinweis zu Verwaltungszugang",
    summary:
      "Archivierte Pilotvorschau für Negativtests. Kein aktiver Draft-Ausgangspunkt und keine produktive Verwaltungsinformation.",
    url: null,
    publishedAt: "2026-05-14T00:00:00.000Z",
    detectedTopics: ["Verwaltung", "Wartezeiten"],
    detectedPlaces: ["Reinickendorf"],
    relatedClaims: [],
    relatedDossiers: [],
    relatedAnlassraumIds: ["regional-anlassraum-reinickendorf"],
    ...
    openQuestions: ["Warum wurde der Hinweis archiviert und nicht weitergeführt?"],
    reviewHint: "Archivierter Negativfall. Keine Draft-Erstellung zulassen.",
  ...
  parseRegionFeedSignal({
    ...
    title: "Pilotvorschau: Wiederkehrendes Thema Schulwege und Verkehr vor Schulen",
    summary:
  ...
  parseRegionFeedSignal({
    ...
    sourceId: "feed-source-reinickendorf-pilot-briefing",
    sourceType: "manual_note",
    title: "Pilotvorschau: Offene Fragen zu Buergeramt und Verwaltungszugang",
    summary:
      "Hinweis aus der Pilotvorschau zu Wartezeiten, Terminzugang und Rueckmeldelogik fuer Verwaltungsleistungen.",
    url: null,
    publishedAt: "2026-05-14T00:00:00.000Z",
  ...
  parseRegionFeedSignal({
    ...
    title: "Pilotvorschau: Soziale Infrastruktur, Jugend-, Sport- und Kulturangebote",
    summary:
      "Community-Hinweis aus der Pilotvorschau zu Nachbarschaft, Jugendangeboten und lokalen Infrastrukturfragen ohne automatische Ableitung.",
    url: null,
    publishedAt: "2026-05-14T00:00:00.000Z",
  ...
  parseRegionFeedSignal({
    ...
    sourceId: "feed-source-reinickendorf-pilot-briefing",
    sourceType: "manual_note",
    title: "Pilotvorschau: Gruenflaechen, Sauberkeit und oeffentlicher Raum",
    summary:
      "Themenverdichtung aus der Pilotvorschau zu Gruenflaechenpflege und Aufenthaltsqualitaet im oeffentlichen Raum.",
    url: null,
    publishedAt: "2026-05-14T00:00:00.000Z",
  ...
  parseRegionFeedSignal({
    id: "region-feed-signal-reinickendorf-rejected-001",
    kind: "region_feed_signal",
    regionId: "bezirk-berlin-reinickendorf",
    sourceId: "feed-source-reinickendorf-pilot-briefing",
    sourceType: "manual_note",
    title: "Pilotvorschau: Abgelehnter Hinweis ohne belastbare Grundlage",
    summary:
      "Abgelehnte Pilotvorschau für Guardrail-Tests. Keine belastbare Nachricht und kein produktiver Verwaltungsinput.",
    url: null,
    publishedAt: "2026-05-14T00:00:00.000Z",
    detectedTopics: ["soziale Infrastruktur"],
    detectedPlaces: ["Reinickendorf"],
    relatedClaims: [],
    relatedDossiers: [],
    relatedAnlassraumIds: [],
    ...
    provenance: PILOT_PROVENANCE,
    clusterKey: "soziale-infrastruktur",
    openQuestions: ["Welche Belege fehlten für eine Weiterführung?"],
    reviewHint: "Abgelehnter Negativfall. Keine Draft-Erstellung zulassen.",
  ...
  parseRegionFeedSignal({
    ...
    sourceType: "manual_note",
    title: "Pilotvorschau: Jugend- und Sportangebote in der Kommune",
    summary:
