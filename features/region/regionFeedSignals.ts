...
export const REGION_FEED_SIGNAL_FIXTURES: readonly RegionFeedSignal[] = [
  parseRegionFeedSignal({
    ...
    sourceType: "official_update",
    title: "Pilot-Fall: Review-bestätigter Hinweis zu Schulsanierung und Bauzustand",
    summary:
      "Akzeptierte Pilot-Fixture für den kontrollierten Draft-Pfad. Keine echte Nachricht, keine produktive Verwaltungsmitteilung.",
    url: null,
    ...
    reviewHint: "Akzeptierte Pilot-Fixture für review-gated Draft-Erstellung. Keine Produktivnachricht.",
  ...
  parseRegionFeedSignal({
    ...
    sourceType: "manual_note",
    title: "Pilot-Fall: Archivierter Hinweis zu Verwaltungszugang",
    summary:
      "Archivierte Pilot-Fixture für Negativtests. Kein aktiver Draft-Ausgangspunkt und keine produktive Verwaltungsinformation.",
    url: null,
    publishedAt: "2026-05-14T00:00:00.000Z",
  ...
  parseRegionFeedSignal({
    ...
    sourceId: "feed-source-reinickendorf-pilot-briefing",
    sourceType: "manual_note",
    title: "Pilot-Fall: Abgelehnter Hinweis ohne belastbare Grundlage",
    summary:
      "Abgelehnte Pilot-Fixture für Guardrail-Tests. Keine belastbare Nachricht und kein produktiver Verwaltungsinput.",
    url: null,
    publishedAt: "2026-05-14T00:00:00.000Z",
