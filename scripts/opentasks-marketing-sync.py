...
head = head.replace(
    ...
    "- Letzter gezielter Kopf-Sync: Marketing Growth OS nach PR `#443` auf aktuellem `main`; nicht berührte operative Zeilen behalten ihren zuletzt verifizierten Status.",
    1,
)
head = head.replace(
